...
I have partially completed the following:
1. Legacy JavaScript Algorithms and Data Structures V8
    - Started immediately after responsive web design.
    - Completed 2 of 5 certification projects.
2. Current Responsive Web Design certification
    - 3 of 5 certification projects are transferrable.
...
I will now share the source code, and demos for the old certifications, and any small personal projects that I think are worth sharing, which don't deserve dedicated repositories.

------
### fCC Projects
These all fall short of my own standards, I was purposely doing the minimum requirements to finish quickly, since they weren't graded. Maybe I will recreate them for practice. I will probably develop a new portfolio site under the same standards as SIA.
...
------
### Random personal scripts and projects:

##### iOS Scriptable routing algorithm
- [Source Code](https://github.com/joshua-hvmn/fcc-certs-and-code/tree/main/freeCodeCamp/personal-projects/ios-scriptable-routing-algorithm/)
- I plan on making a webpage to demo this script.